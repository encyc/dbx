...
export default withEnglishFallback({
  ...
  functionDictionary: {
    ...
    noConnection: "接続済みのクエリタブを開くと関数辞典を閲覧できます",
    noData: "{type} の組み込み関数データはまだありません",
    functionsCount: "{count} 個の関数",
    allGroups: "すべて",
    moreResults: "他 {count} 件 — 入力を続けて絞り込んでください",
    overloads: "{count} 個のオーバーロード",
    aliases: "エイリアス: {aliases}",
    argsCount: "引数 {count}",
    copy: "コピー",
    copied: "コピーしました",
