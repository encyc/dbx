...
export default withEnglishFallback({
  ...
  functionDictionary: {
    ...
    noConnection: "Abra uma aba de consulta com conexão para navegar pelo dicionário de funções",
    noData: "Ainda não há dados de funções integradas para {type}",
    functionsCount: "{count} funções",
    allGroups: "Todas",
    moreResults: "+{count} mais — continue digitando para refinar",
